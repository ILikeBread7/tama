...
GJAPI.iGameID    = 562638;      // # change this
GJAPI.sGameKey   = "184ec917d64d04068959612ec816eef0";     // # change this too
...
{
    if(!GJAPI.bActive) {GJAPI.LogTrace("ScoreAdd(" + iScoreTableID + ", " + iScoreValue + ", " + sScoreText + ") failed: no user logged in"); return false;}
